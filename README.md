...
PHANTOM-X is a state-of-the-art security platform designed for researchers, penetration testers, and security analysts. It bundles **72 industry-standard auditing tools** across **12 categories** into a unified workspace, served via a beautiful glassmorphic Web Console and an interactive dynamic Command Line Interface (CLI).
...
*   **72 Audited & Verified Tools**: 100% of the tools in the catalog are tested, patched, and confirmed working (0 dead tools).
...
## 📂 Catalog (12 Categories & 72 Tools)
...
| Red Team & Emulation | Linux Admin & Security | Mobile Debugging & Auditing | Top 15 Must Learn Tools |
|---|---|---|---|
| • MITRE Caldera<br>• Atomic Red Team<br>• Prelude Operator<br>• Metasploit Framework<br>• NetExec<br>• Impacket Suite<br>• Evil-WinRM | • Lynis<br>• OpenSCAP<br>• Falco<br>• Auditd Userspace | • ADB (Android Debug Bridge) | • Nmap, Wireshark, Burp Suite, Nuclei, Amass, Subfinder, ffuf, sqlmap, Wazuh, Suricata, Zeek, Volatility3, Autopsy, Lynis, Falco |
